    ...
    <StyledPagination>
      <ul className='pagination'>
        {totalItems !== 0 && currentPage !== '1' && (
          <NavLink className={'img-wrapper'} to={`/initiatives/page-${currentPage === 1 ? '1' : currentPage - 1}`}>
        ...
        {totalItems !== 0 && parseInt(currentPage) !== lastPage && (
          <NavLink
            ...
            to={`/initiatives/page-${currentPage === lastPage ? lastPage : parseInt(currentPage) + 1}`}
          >
